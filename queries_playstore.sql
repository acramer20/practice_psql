...
-- (Maybe we can go over the other option here and why that would be more useful or if this is the best way)
...
-- The WHERE clause affects each element whereas the HAVING clause affects the groups created by the GROUP BY clause. 
-- ****** Could still use a little bit of a break down of this specific query.******
...
-- WOuld love to go over this one. above
