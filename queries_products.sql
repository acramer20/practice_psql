...
-- 2 and 3)  INSERT INTO products(name, price, can_be_returned) VALUES ('stool', '25.99','true'), ('table','124.00','false');
-- 4) SELECT * FROM products;
-- 5) SELECT name FROM products;
-- 6) SELECT name, price FROM products;
-- 7) INSERT INTO products(name, price, can_be_returned) VALUES ('couch','2000.99','true');
...
-- Corresponding comments for what each query is doing below: 
